<?php /*Pleiades Moon: Color Patterns */

// Generate the CSS for the current custom color scheme.

function pleiadesmoon_custom_colors_css() {
	$hue = absint(get_theme_mod('colorscheme_hue', 250));

	$saturation = absint(apply_filters('pleiadesmoon_custom_colors_saturation', 50));
	$reduced_saturation = (0.8 * $saturation) . '%';
	$saturation = $saturation . '%';
	$css = '
/**
 * Pleiades Moon: Color Patterns
 *
...
.colors-custom.page:not(.pleiadesmoon-front-page) .entry-title,
...
.colors-custom .pleiadesmoon-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.pleiadesmoon-front-page .panel-content .recent-posts article,
...
.colors-custom.pleiadesmoon-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	return apply_filters('pleiadesmoon_custom_colors_css', $css, $hue, $saturation);
}
